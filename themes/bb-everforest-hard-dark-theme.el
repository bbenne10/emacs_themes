;;; bb-everforest-hard-dark-theme.el --- Everforest Hard Dark Theme -*- lexical-binding: t; -*-

;; Copyright (C) 2023 Bryan Bennett, Evan Sarris
...
(deftheme bb-everforest-hard-dark
...
(everforest-hard-dark-with-color-variables
  (custom-theme-set-faces
   ...
   ;; ansi/term colors
   `(ansi-color-black   ((t (:foreground ,everforest-hard-dark-black))))
   `(ansi-color-blue    ((t (:foreground ,everforest-hard-dark-blue))))
   `(ansi-color-cyan    ((t (:foreground ,everforest-hard-dark-cyan))))
   `(ansi-color-green   ((t (:foreground ,everforest-hard-dark-green))))
   `(ansi-color-magenta ((t (:foreground ,everforest-hard-dark-purple))))
   `(ansi-color-red     ((t (:foreground ,everforest-hard-dark-red))))
   `(ansi-color-yellow  ((t (:foreground ,everforest-hard-dark-yellow))))
   `(ansi-color-white   ((t (:foreground ,everforest-hard-dark-fg))))
   
   ;; TODO: maybe these should be different?
   `(ansi-color-bright-black   ((t (:foreground ,everforest-hard-dark-black))))
   `(ansi-color-bright-blue    ((t (:foreground ,everforest-hard-dark-blue))))
   `(ansi-color-bright-cyan    ((t (:foreground ,everforest-hard-dark-cyan))))
   `(ansi-color-bright-green   ((t (:foreground ,everforest-hard-dark-green))))
   `(ansi-color-bright-magenta ((t (:foreground ,everforest-hard-dark-purple))))
   `(ansi-color-bright-red     ((t (:foreground ,everforest-hard-dark-red))))
   `(ansi-color-bright-yellow  ((t (:foreground ,everforest-hard-dark-yellow))))
   `(ansi-color-bright-white   ((t (:foreground ,everforest-hard-dark-fg))))
   ...
   ;; mode-line
   `(mode-line           ((t (:background ,everforest-hard-dark-visual
                              :foreground ,everforest-hard-dark-silver
                              :box (:line-width 6
                                    :color ,everforest-hard-dark-visual
                                    :style nil)))))
   `(mode-line-buffer-id ((t (:weight bold))))
   `(mode-line-emphasis  ((t (:weight bold))))
   `(mode-line-inactive  ((t (:background ,everforest-hard-dark-bg
                              :foreground ,everforest-hard-dark-silver
                              :box (:line-width 6
                                    :color ,everforest-hard-dark-bg
                                    :style nil)))))
   ...
   ;; corfu
   `(corfu-default ((t  (:foreground ,everforest-hard-dark-fg :background ,everforest-hard-dark-gray))))
   `(corfu-current ((t  (:foreground ,everforest-hard-dark-bg :background ,everforest-hard-dark-green))))
...
(provide-theme 'bb-everforest-hard-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:
;;; bb-everforest-hard-dark-theme.el ends here
